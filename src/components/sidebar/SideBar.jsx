...
const SideBar = ({currentPage, setCurrentPage}) => {
  ...
  return (
    <>
      <SideBarButton isOpen={isOpen} setIsOpen={() => setIsOpen(!isOpen)}/>
      <div className={`text-4xl fixed top-0 left-0 ${isOpen ? "translate-x-0" : "-translate-x-full"} w-66 transition-all duration-300 ease-out`}>
        ...
        <div className="bg-slate-950 h-full rounded-r-2xl text-cyan-100 text-sm p-5 flex flex-col">
          ...
          <Menu title="🏠 Manajemen Kos" items={[{component: "Ruangan", name: "Daftar Ruangan"}, {component: "StatusKetersediaan", name: "Status Ruangan"}]} currentPage={currentPage} setCurrentPage={setCurrentPage}/>
